...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__styles_bundle_scss__ = __webpack_require__(329);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__styles_bundle_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__styles_bundle_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__js_app_js__ = __webpack_require__(330);
...
window.onload = function getMap() {
  ...
  elements.roadTripBtn.addEventListener('click', function () {
    handlers.roadTripBtnClick();
  });
  elements.vacationBtn.addEventListener('click', function () {
    handlers.vacationBtnClick();
  });
  elements.destinationBtn.addEventListener('click', function () {
    handlers.destinationBtnClick();
  });
  elements.searchBtn.addEventListener('click', function () {
    handlers.searchBtnClick();
  });
  elements.getDirectionsBtn.addEventListener('click', function () {
    handlers.getDirectionsBtnClick();
  });
  elements.locateMeBtn.addEventListener('click', function () {
    handlers.locateMeBtnClick();
  });
  elements.resetBtn.addEventListener('click', function () {
    handlers.resetBtnClick();
  });
  elements.getDirectionsContainer.addEventListener('mouseover', function () {
    map.setOptions({ disableZooming: true });
  });
  elements.getDirectionsContainer.addEventListener('mouseout', function () {
